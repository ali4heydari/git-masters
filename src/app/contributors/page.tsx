      ...
      <section className="border-b border-border bg-muted/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">Student Contributors</h1>
            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
              A living record of everyone who has completed the Git Masters workshop. Add your name by contributing to
          ...
          <Card className="p-6 md:p-8 border-2 border-primary/20 bg-muted/30">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <div
                  className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground font-bold text-sm">
                  1
                </div>
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Create a new branch for your contribution</p>
                  <div className="rounded-lg bg-background border border-border p-4 font-mono text-sm overflow-x-auto">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Add file <code className="px-1.5 py-0.5 rounded bg-muted text-xs">_markdowns/_participants/your-name.md</code> and
                    add your details with the format bellow:
                  </p>
                  <div className="rounded-lg bg-background border border-border p-4 font-mono text-sm overflow-x-auto">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Commit your changes and push to your fork</p>
                  <div className="rounded-lg bg-background border border-border p-4 font-mono text-sm overflow-x-auto">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Open a Pull Request on GitHub with a clear title</p>
            ...
            <div className="mt-8 pt-6 border-t border-border">
              <Button asChild className="w-full sm:w-auto">
                <Link href="https://github.com/Ali4Heydari/git-masters" target="_blank" rel="noopener noreferrer">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">{contributors.length} students have completed the workshop</p>
          </div>
            ...
            {contributors.map((contributor, index) => (
              <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-start gap-4">
                  <img
                    src={`https://github.com/${contributor.githubUserName}.png` || "/placeholder.svg"}
                    alt={`${contributor.firstName} ${contributor.lastName}`}
                    className="h-16 w-16 rounded-full border-2 border-border"
                  />
                  <div className="flex-1 min-w-0">
                    <h3
                      className="font-semibold text-lg mb-1 truncate">{`${contributor.firstName} ${contributor.lastName}`}</h3>
                    <Link
